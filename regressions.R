...
kr_hr_country_data_results <- kr_hr_country_data[, lapply(.SD, exp), by=c("outcome", "id", "term", "p.value"), .SDcols = for_exp]

kr_hr_country_data_results[kr_hr_country_data_results$estimate==Inf] <- NA
kr_hr_country_data_results[kr_hr_country_data_results$estimate==0] <- NA
kr_hr_country_data_results[kr_hr_country_data_results$estimate<0.1] <- NA
